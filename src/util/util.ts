 ...
 */
/**
 * specfocus fork: 40, not 25 (Lucas, 2026-09-14: a place is baked to z31, the camera to z36, and
 * the rest is digital zoom; 2^40 tile coordinates still sit far below a double's 2^53).
 * Upstream stops at 25 because tile keys were packed into one double and x/y went through
 * 32-bit shifts; both are gone (string keys, 2 ** z), so the only limit left is what a
 * picture pyramid needs.
 */
